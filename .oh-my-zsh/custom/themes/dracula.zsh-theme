...
PROMPT+='%F{green}%B$(dracula_context)'
# }}}
...
PROMPT+='%F{blue}%B$(dracula_time_segment)'
# }}}
...
PROMPT+='%F{bright_wight}%B$(dracula_directory)'
# }}}
...
ZSH_THEME_GIT_PROMPT_DIRTY=" %F{red}%B●"
ZSH_THEME_GIT_PROMPT_PREFIX="%F{green}[%F{green}%B"
